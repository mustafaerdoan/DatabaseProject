...
--! Creating info table that holds information about the individual train infos that run between two stations
CREATE TABLE INFO(
ID INT IDENTITY(1,1) NOT NULL PRIMARY KEY CLUSTERED,
   INFO_ID AS 'TK' + RIGHT('00000000' + CAST(ID AS VARCHAR(8)), 8) PERSISTED,
